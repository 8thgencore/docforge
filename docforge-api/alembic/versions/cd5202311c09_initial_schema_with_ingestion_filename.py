"""initial schema with ingestion filename

Revision ID: cd5202311c09
Revises: 
Create Date: 2026-02-22 03:48:09.863127
"""
...
def upgrade() -> None:
    ...
    sa.Column('group_id', sa.UUID(), nullable=False),
    sa.Column('status', sa.Enum('queued', 'running', 'retrying', 'paused', 'failed', 'completed', name='ingestionstatus'), nullable=False),
    sa.Column('stage', sa.Enum('queued', 'parsing', 'indexing', 'paused', 'failed', 'completed', name='ingestionstage'), nullable=False),
